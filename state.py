...
class State():
    def __init__(self, name, dem, gop, ec):
        ...
        self.gop - int, number of Republican votes cast
    ...
    def get_margin(self):
        ...
        """
        return abs(int(self.dem)-int(self.gop))
    ...
    def get_winner(self):
        ...
        """
        if int(self.dem)-int(self.gop) > 0:
            return "dem"
        else:
            return "gop"
    ...
    def __copy__(self):
        ...
        """
        return State(self.name, self.dem, self.gop, self.ec)
